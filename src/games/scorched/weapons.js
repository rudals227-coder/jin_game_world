...
export const SPECIALS = [
  ...
  { id: 'bunker',  name: '벙커버스터', icon: '🛢', radius: 54,  damage: 48, desc: '땅을 아주 깊숙이 뚫고 들어가 폭발', pierce: 130 },
  ...
  { id: 'magnet',  name: '자석탄',     icon: '🧲', radius: 175, damage: 10, desc: '넓은 범위에서 상대를 끌어당김(추락 유도)', magnet: true },
